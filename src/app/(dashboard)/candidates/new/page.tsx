      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-medium text-white/80 mb-1">Current Title</label>
                <input name="currentTitle" value={form.currentTitle} onChange={handleChange} className={inputClass} placeholder="Software Engineer" />
              </div>
              <div>
                <label className="block text-xs font-medium text-white/80 mb-1">Current Company</label>
                <input name="currentCompany" value={form.currentCompany} onChange={handleChange} className={inputClass} placeholder="Acme Corp" />
              </div>
            </div>

            <div>
              <label className="block text-xs font-medium text-white/80 mb-1">LinkedIn URL</label>
            ...
            <div>
              <label className="block text-xs font-medium text-white/80 mb-1">Source</label>
            ...
            <div>
              <label className="block text-xs font-medium text-white/80 mb-1">Skills</label>
            ...
            <div>
              <label className="block text-xs font-medium text-white/80 mb-1">Summary</label>
